...
class Agent_DDPG_TD3_AAC(Agent):
    def __init__(self, state_shape, action_type, action_params,
        ...
        super(Agent_DDPG_TD3_AAC, self).__init__(state_shape, action_type,
    ...
    def bias_calculation(self, batch_size = 128):
        ...
        # print(enlarged_state_batch.size())
        ...
        if os.path.exists("Logs/" + self.args.env_name + "_.npz"):
            data = np.load("Logs/" + self.args.env_name + "_.npz")
            data_bias = data["bias"]
        ...
        np.savez("Logs/" + self.args.env_name + "_.npz",
